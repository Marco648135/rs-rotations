<script>
    ...
    const abilities = Object.fromEntries(
        Object.entries(abils).filter(([, a]) =>
            a.title && a.mainStyle === 'necromancy' &&
    ...
    if (typeof localStorage !== 'undefined') {
        storedSettings = JSON.parse(localStorage.getItem('settings_necro_rb')) || {};
    }
        ...
        Object.fromEntries(
            Object.entries(settingsConfig).map(([key, value]) => [
                key,
                {
                    ...value,
                    key,
                    value: coerceEquipmentValue(storedSettings[key]?.value ?? value.default?.necromancy ?? value.default, key)
                }
            ])
        )
    );
    ...
    function saveSettings() {
        if (typeof localStorage !== 'undefined') {
            ...
            localStorage.setItem('settings_necro_rb', JSON.stringify(settingsToSave));
        }
    }
...
<Navbar />
<Header
    img="/rs-rot/necro_background.png"
    text="Necromancy Calculator"
    icon="/rs-rot/style_icons/necro-white.svg"
/>
                        ...
                        {#if tab === 'general'}
                            ...
                            <div class="md:col-span-1 space-y-2">
                                ...
                                <Checkbox
                                    ...
                                    onchange={() => updateDamages()}
                                    img="/rs-rot/effect_icons/necromancy/death_spark2.png"
                                />
                                <Number
                                    bind:setting={settings[SETTINGS.RESIDUAL_SOULS]}
                                    onchange={() => updateDamages()}
                                    img="/rs-rot/ability_icons/necro/30x30/soul-sap.png"
                                    step="1"
                                    max="5"
                                    min="0"
                                />
                                <Checkbox
                                    ...
                                    onchange={() => updateDamages()}
                                    img="/rs-rot/effect_icons/living_death.png"
                                />
                                <Number
                                    bind:setting={settings[SETTINGS.SKELETON_WARRIOR_RAGE_STACKS]}
                                    onchange={() => updateDamages()}
                                    img="/rs-rot/effect_icons/skeleton_rage.png"
                                    step="1"
                                    max="25"
                                    min="0"
                                />
                                <Number
                                    ...
                                    onchange={() => updateDamages()}
                                    img="/rs-rot/ability_icons/necro/30x30/command_phantom_guardian.png"
                                    step="1"
                                    max="25"
                                    min="0"
                                />
                                <Number
                                    ...
                                    onchange={() => updateDamages()}
                                    img="/rs-rot/effect_icons/necrosis.png"
                                    step="1"
                                    max="12"
                                    min="0"
                                />
                    ...
                    <div class="card card-necro">
                        ...
                        <div class="pb-5">
                            <p>
                                ...
                                Compare results with the original necromancy page to verify accuracy.
                            </p>
                        </div>
                        <div>
                            <p>
